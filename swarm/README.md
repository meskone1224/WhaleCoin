...
Building Swarm requires Go (version 1.10 or later).
    ...
    go install github.com/WhaleCoinOrg/WhaleCoin/cmd/swarm
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/WhaleCoinOrg/WhaleCoin/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/WhaleCoinOrg/WhaleCoin/wiki/Code-Review-Guidelines).
